...
Les présentes Conditions Générales de Vente (CGV) encadrent les transactions effectuées sur le site [https://purplerouen.fr](https://purplerouen.fr) entre :
...
Et :
**L'Acheteur :** Toute personne physique ou morale passant commande sur le site.
...
Les informations collectées sont nécessaires pour traiter votre commande. Elles sont gérées sous la responsabilité de l'AS INSA Rouen.
Contact DPO : [dpo@purplerouen.fr](mailto:dpo@purplerouen.fr).

## Article 9 : Réclamations et médiation

Pour toute réclamation, contactez d'abord le **Responsable des Inscriptions** : [inscriptions@purplerouen.fr](mailto:inscriptions@purplerouen.fr).

Si le litige persiste, vous pouvez recourir gratuitement à un médiateur de la consommation (Articles L.616-1 et R.616-1 du Code de la consommation).
